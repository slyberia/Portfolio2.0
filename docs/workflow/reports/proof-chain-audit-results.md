...
*   **Portfolio 2.0 (Codex Technical Tide / AI Workflow):** 
    *   *Claim:* "Formalized automation pipeline governance."
    *   *Evidence:* Executive Summaries generated during development.
    *   *Proof:* 6 screenshots registered in `mediaRegistry.ts` (e.g., `portfolio-v2-home-hero-desktop-v1`, `portfolio-v2-site-index-desktop-v1`).
*   **Spatial Intel Ops:**
    *   *Claim:* "Spatial intelligence mapping integration."
    *   *Proof:* 1 screenshot registered (`spatial-intel-ops-spatial-intel-detail-desktop-v1`).
...
*   *Example 1:* The Digital Twin's claim of "Failure Mode Resilience" is proven by the `Failure Mode Matrix` markdown table.
*   *Example 2:* The Prompter Hub's claim of a "Recursive Inference Engine" is proven by the `Schema Builder Logic` code block.
