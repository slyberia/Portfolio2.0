...
export const SKILL_CHIP_CONFIG: Record<string, SkillChipConfig> = {
  ...
  'Salesforce & CRM': {
    ...
    evidenceNote:
      'Luxe Lofts prototype includes a proposed CRM path. The case study names Salesforce as a possible integration; deployed CRM migration is not established.',
  },
  Zendesk: {
    linkMode: 'flagged',
    linkedSlugs: [],
...
export const PROJECT_REGISTRY: ProjectEntry[] = [
  ...
  <div style="padding:10px 14px;border:1px solid #cbd5e1;border-radius:10px;background:#fff;text-align:center;font-weight:600;">High-volume utility request intake</div>
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
    ...
    <div style="border:1px solid #bfdbfe;border-radius:10px;background:#f5f9ff;padding:12px;">
      ...
      <div style="font-size:12px;line-height:1.6;color:#334155;">Structural check<br/>↓<br/>Human contextual review<br/>↓<br/><strong>Reviewed or escalated</strong></div>
    </div>
  </div>
  ...
  <p style="margin:10px 0 0;font-size:11px;color:#475569;font-style:italic;line-height:1.5;">Conceptual workflow with synthetic dashboard values. The prior audit records Kyle-confirmed utility workload of 100+ work orders/day; a separate résumé entry reports 120+ weekly requests. Neither is a result of this simulator. No numeric first-pass yield is claimed.</p>
</div>`,
    },
    rigor: {
