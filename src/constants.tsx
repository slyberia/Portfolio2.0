...
export const PROJECT_REGISTRY: ProjectEntry[] = [
  ...
  <p style="margin:10px 0 0;font-size:11px;color:#94a3b8;font-style:italic;line-height:1.5;">Historical workload / QA context from the original utility-data GIS role: 120+ requests/week reflects the production queue scale that motivated the triage model, and 98% first-pass yield the quality-performance context it was designed around. These are operating conditions used as context — not outputs generated by this demo.</p>
</div>`,
    },
    rigor: {
