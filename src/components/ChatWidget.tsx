...
> = {
  general: {
    ...
    suggestions: [
      ...
      'Explain the HPS Geospatial workflow and its validation limits.',
  ...
  implementation: {
    label: 'Forward Deployed Track',
    intro:
      'You’re viewing Kyle’s Forward Deployed Engineer track. I can help you inspect proof around workflow delivery, implementation planning, documentation, Guynode, the Digital Twin, and customer-facing technical support.',
    suggestions: [
  ...
  gis: {
    label: 'Spatial Systems Track',
    intro:
      'You’re viewing Kyle’s Spatial Systems Architect track. I can help you inspect proof around Guynode, spatial data workflows, metadata, dataset governance, map-based UX, and utility GIS operations.',
    suggestions: [
      'Show me Kyle’s Spatial Systems Architect proof.',
