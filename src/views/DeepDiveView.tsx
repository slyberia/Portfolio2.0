        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          {activeSection === 'ai-assisted-delivery-model' && (
            ...
            >
              ...
              <p>
                ...
                branch-level task, reviewed the resulting patch notes, validated the output, and
                used follow-up prompts to resolve defects or drift.
              </p>
          ...
          {activeSection === 'digital-twin-governance' && (
            ...
            >
              ...
              <p>
                The Digital Twin is designed as a scoped AI support system, not a general chatbot.
                Its value comes from how it handles relevance, cost, routing, failure states, and
                human escalation.
              </p>
              <p>
                ...
                behaviors, and human handoff when confidence or relevance fails. QA scenarios and
                tests focus on these constraints, not open-ended chat performance.
              </p>
            </section>
          )}
          ...
          {activeSection === 'evidence-ledger' && (
            ...
            >
              ...
              <p className="mt-2">
                ...
                source trail: files, phases, decisions, Git evidence, validation notes, and
                remaining risks. In this repo, it is maintained as an internal documentation
