...
const GALLERY_AI_ASSETS: AIVisualAsset[] = [
  {
    ...
    prompt:
      'midcentury modern luxury penthouse interior, concrete plaster walls, warm glowing brass highlights, large architectural windows, ann arbor cityscape at dusk, architectural digest style, cinematic lighting --ar 16:9 --v 6.0',
    seed: 849301824,
  ...
  },
  {
    ...
    prompt:
      'Sleek futuristic operations control dashboard interface, complex node graph network, cybersecurity data visualization overlay, cybernetic color palette with amber and cyan accents, HUD layout, user interface design --ar 16:9 --v 6.0',
    seed: 194857104,
    model: 'Midjourney v6.0',
  ...
  },
  {
    ...
    prompt:
      'Set of flat vector glyph icons for spatial and geographical information systems, clean golden ratio curves, minimalist architectural lines, deep slate background, vector art, behance style --ar 1:1 --v 6.0',
    seed: 90231847,
    model: 'DALL-E 3',
