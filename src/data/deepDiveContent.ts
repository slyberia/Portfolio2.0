...
export const decisionBlocks: DecisionBlock[] = [
  {
    ...
    decision:
      'Restructured into three explicit role tracks — Forward Deployed Engineer, Implementation Consultant, and Spatial Systems Architect — each with dedicated proof blocks, artifacts, and CTAs.',
    tradeoff:
